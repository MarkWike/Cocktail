//
//  UserDrinksIngreientBoxView.swift
//  Cocktail
//
...
struct UserDrinksIngreientBoxView: View {
...
struct UserDrinksIngreientBoxView_Previews: PreviewProvider {
    static var previews: some View {
        UserDrinksIngreientBoxView()
    }
}
